...
import { createDonationColumns } from "@/features/donations/components/columns";
...
function DonationsListPage() {
  ...
  const columns = useMemo(
    () =>
      createDonationColumns(
        (id) => navigate({ to: "/donations/$id", params: { id } }),
        (id) => navigate({ to: "/donations/$id/edit", params: { id } }),
        (id) => {
    ...
    <AppLayout>
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          >
            <Button
              onClick={() => navigate({ to: "/donations/create" })}
              variant="default"
            >
        ...
        >
          <div className="relative flex-1">
            ...
            <Input
              placeholder="Search by donor, receipt number, purpose, or program..."
              value={searchQuery}
        ...
        <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Are you sure you want to delete this donation (Receipt:{" "}
                {selectedDonation?.receiptNumber})? This action cannot be undone.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
